...
<svg width="683" height="577" viewBox="0 0 683 577" fill="none" xmlns="http://www.w3.org/2000/svg">
	<g id="scheme">
		...
		<g id="f v6">
			<path d="M128 353L128 374H116L116 353L128 353Z" fill={pipeColor(isCoolingConsumers && v5)} />
		...
		<g
			id="Pump"
			on:click={() => (pump1Working ? (statePump1 = 'off') : (statePump1 = 'HS'))}
		...
		<g
			id="Pump_2"
			on:click={() => (pump2Working ? (statePump2 = 'off') : (statePump2 = 'HS'))}
		...
		<g
			id="Pump_3"
			on:click={() => (pump3Working ? (statePump3 = 'off') : (statePump3 = 'HS'))}
		...
		>
			...
			<text
				...
				font-family="Inter"
				font-size="12"
				letter-spacing="0em"><tspan x="95.0001" y="210.864">&#x426;&#x41d; III-&#x420;</tspan></text
			>
		</g>
